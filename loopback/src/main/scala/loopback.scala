...
/**
  * Loopback Tester (connects the driver and DUT)
  */
...
/**
  * Loopback Tester Application Entry Point
  */
...
/**
  * Loopback Build Application Entry Point
  */
object Synth extends App {
  val top = new loopback
  top.printCodeString.compile.printCodeString
  .toFile("loopback/zedboard/loopback_ait/xilinx/HLS/loopback/solution1/impl/ip/hdl/vhdl/loopback_moved.vhd")
}
